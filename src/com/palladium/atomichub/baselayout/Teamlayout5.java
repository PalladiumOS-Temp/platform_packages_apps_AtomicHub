...
public class Teamlayout5 extends LinearLayout {


    public Teamlayout5(Context context) {
        super(context);
        abrir(context, null,0,0);
    }

    public Teamlayout5(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        abrir(context, attrs, 0,0);
    }

    public Teamlayout5(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        abrir(context, attrs, defStyleAttr,0);
    }

    public Teamlayout5(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void abrir(Context c, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        Drawable potd = getResources().getDrawable(R.mipmap.ic_sps_round);
        ...
        Drawable d = getResources().getDrawable(R.drawable.ic_sps_head);
        tj.setImageDrawable(d);
        LayoutParams ptj = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.MATCH_PARENT);
        ptj.weight = 1;
        ...
        ghj.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                String url = "https://github.com/SukeeratSG";
        ...
        tmj.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://t.me/IronGFly";
                Intent Getintent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                c.startActivity(Getintent);
            }
        });

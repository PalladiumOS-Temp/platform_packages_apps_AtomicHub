...
public class Teamlayout extends LinearLayout {
    ...
    public Teamlayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        abrir(context, attrs, 0,0);
    }

    public Teamlayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        abrir(context, attrs, defStyleAttr,0);
    }

    public Teamlayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void abrir(Context c, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        addView(lj);
        lj.setElevation(50);
        LinearLayout.LayoutParams plj = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        Drawable potd = getResources().getDrawable(R.mipmap.ic_jeev_round);
        pot.setImageDrawable(potd);
        LinearLayout.LayoutParams ppot = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.MATCH_PARENT);
        ppot.weight = 1;
        pot.setPadding(50,50,50,50);
        lj1.addView(pot);
        ImageView tj = new ImageView(c);
        Drawable d = getResources().getDrawable(R.drawable.ic_jeev_head);
        ...
        ghj.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                String url = "https://github.com/zoldycc";

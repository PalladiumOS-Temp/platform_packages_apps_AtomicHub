...
public class Teamlayout4 extends LinearLayout {


    public Teamlayout4(Context context) {
        super(context);
        abrir(context, null,0,0);
    }

    public Teamlayout4(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        abrir(context, attrs, 0,0);
    }

    public Teamlayout4(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        abrir(context, attrs, defStyleAttr,0);
    }

    public Teamlayout4(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void abrir(Context c, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        Drawable potd = getResources().getDrawable(R.mipmap.ic_syzgy);
        ...
        Drawable d = getResources().getDrawable(R.drawable.ic_syzgy_head);
        ...
        ghj.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                String url = "https://github.com/sairpa";
        ...
        tmj.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://t.me/palladiumos";
                Intent Getintent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                c.startActivity(Getintent);
            }
        });

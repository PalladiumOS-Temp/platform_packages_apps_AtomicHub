...
public class Teamlayout3 extends LinearLayout {


    public Teamlayout3(Context context) {
        super(context);
        abrir(context, null,0,0);
    }

    public Teamlayout3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        abrir(context, attrs, 0,0);
    }

    public Teamlayout3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        abrir(context, attrs, defStyleAttr,0);
    }

    public Teamlayout3(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void abrir(Context c, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        Drawable potd = getResources().getDrawable(R.mipmap.ic_rpa);
        ...
        Drawable d = getResources().getDrawable(R.drawable.ic_rpa_head);
